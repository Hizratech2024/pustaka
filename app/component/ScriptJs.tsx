...
export default function
    ...
    return (
        <>
            <script src="/tema/vendor/apexcharts/apexcharts.min.js"></script>
            ...
            <script src="/tema/vendor/simple-datatables/simple-datatables.js"></script>
            <script src="/tema/vendor/tinymce/tinymce.min.js"></script>
