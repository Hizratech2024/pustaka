...
function Add({ reload }: { reload: Function }) {
    ...
    const handleSubmit = async (e: SyntheticEvent) => {
        ...
        try {
            ...
            const uploadResult = await supabase.storage
                .from(supabaseBUCKET)
                .upload(`foto-slide-pustaka/${namaunik}`, image);
    ...
    return (
        <div>
            <button onClick={handleShow} type="button" className="btn btn-success btn-icon-text mt-3">
                Tambah Slide</button>
            <Modal
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <Modal.Body>
                        ...
                        <div className="mb-3 row">
                            <label className="col-sm-3 col-form-label" >Nama Slide</label>
                            <div className="col-sm-9">
                                <input
                                    required
                                    type="text"
