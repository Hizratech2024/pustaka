...
const Rak = () => {
    ...
    const filteredItems = all ? datarak : datarak.filter(
        (item: any) => item.lemariId == Number(lemariId)
    );
                    ...
                    <div className="card">
                            ...
                            <div className="card-title col-md-6 mt-2">
                                <div className="row">
                                    <div className="col-md-3">
                                        <h6 className="card-title" style={{fontWeight:'bold'}}>Lemari</h6>
                                    </div>
                                    <div className="col-md-6">
                                        ...
                                        >
                                            ...
                                            <option value="Semua Data" style={{ fontWeight: 'bold' }}>Semua Lemari</option>
                        ...
                        <div className="card-body">
                            <div className="row mb-3">
                                <div className="col-md-3">
                                    <AddAll reload={reload} lemari={datalemari} pilihlemariId={lemariId} />
                                    <Add reload={reload} lemariId={lemariId} namalemari={namalemari} />
                                </div>
                            </div>
                            <DataTable
                                columns={columns}
