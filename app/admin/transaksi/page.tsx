...
const Kasir = () => {
  ...
  const [cetakfakturulang, setCetakfakturulang] = useState([]);
  ...
  return (
    <div>
              ...
              <form className="" onSubmit={handleSubmit}>
                ...
                <Col md={5} className="mb-1">
                  <span className="p-buttonset">
                    ...
                    <Button label="Cetak Ulang Faktur" type="button" onClick={handleShow2} icon="mdi mdi-printer" severity="success" />
                  </span>
                </Col>
              </form>
            </div>
                ...
                <tbody>
                  {inputFields.map((x: any, index) => (
                    <tr className="hover" key={x.id}>
                      ...
                      <td style={{ fontSize: 18, color: "black" }}> {rupiah(x.hargaJual)}</td>
                      <td style={{ fontSize: 18, color: "black" }}>{x.qty}</td>
                      <td style={{ fontSize: 18, color: "black" }}>{rupiah(x.subtotal)}</td>
                    </tr>
                  ))}
                </tbody>
                <tfoot className="">
      ...
      <Modal
        ...
        <form>
          <Modal.Header closeButton>
            <Modal.Title>Cetak Faktur</Modal.Title>
          </Modal.Header>
          <Modal.Body>
            ...
            <DataTable
              columns={columns}
              data={cetakfakturulang}
              pagination
              persistTableHead
              responsive
              paginationPerPage={itemsPerPage}
              paginationTotalRows={cetakfakturulang.length}
