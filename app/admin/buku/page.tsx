...
const Buku = () => {
    ...
    const filteredItems = all ? databuku : databuku.filter(
        (item: any) => item.kategoriId == Number(kategoriId)
    );
                    ...
                    <div className="card">
                            ...
                            <div className="card-title col-md-6 mt-2">
                                <div className="row">
                                    <div className="col-md-3">
                                        <h6 className="card-title" style={{fontWeight:'bold'}}>Kategori</h6>
                                    </div>
                        ...
                        <div className="card-body">
                            <div className="row mb-3">
                                ...
                                <div className="col-md-3">
                                    <AddAll reload={reload} kategori={datakategori} pilihkategoriId={kategoriId} />
                                    <Add reload={reload} kategoriId={kategoriId} namakategori={namaKategori} />
                                </div>
                            </div>
                            <DataTable
                                columns={columns}
