...
function AddAll({ reload, kategori, pilihkategoriId }: { reload: Function, kategori: Array<any>, pilihkategoriId: String }) {
                    ...
                    <Modal.Header closeButton>
                        <Modal.Title>
                            ...
                            <div className=" d-flex align-items-center">
                                <span className="me-5" style={{ fontFamily: 'initial', fontWeight: 'bold' }}>Kategori</span>
                                <span>
                                    <select
                                        required
